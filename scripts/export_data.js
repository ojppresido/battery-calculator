...
//   SUPABASE_URL=https://xxx.supabase.co SUPABASE_ANON_KEY=eyJ... node scripts/export_data.js
//
...
(async function () {
  ...
  console.log("\nWrote " + out + " (" + total + " rows)" + (missing.length ? "\nMissing tables (run migrations 0001+0002): " + missing.join(", ") : ""));
